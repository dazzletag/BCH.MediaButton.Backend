...
namespace MediaButton.Backend.Api.Data.Migrations
{
    ...
    [Migration("20260522105011_AddUserManagement")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MediaButtonBackend.Models.CareHome", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("MediaButtonBackend.Models.ResidentAccessGrant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("UserProfileId", "ResidentKey")
                        .IsUnique();

                    b.ToTable("ResidentAccessGrants");
                });
            ...
            modelBuilder.Entity("MediaButtonBackend.Models.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("AzureAdEmail")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("MediaButtonBackend.Models.ResidentAccessGrant", b =>
                {
                    b.HasOne("MediaButtonBackend.Models.UserProfile", "UserProfile")
            ...
            modelBuilder.Entity("MediaButtonBackend.Models.UserProfile", b =>
                {
                    b.HasOne("MediaButtonBackend.Models.CareHome", "CareHome")
                        .WithMany()
